...
exports.MCP_SERVICES_WINDOWS_CONFIG = void 0;
...
exports.MCP_SERVICES_WINDOWS_CONFIG = {
    // Code Checker MCP (Python) - Direct execution
    'code-checker': {
        name: 'code-checker',
        command: 'python3',
        args: ['-u', 'real_mcp_server.py'],
        cwd: path_1.default.join(BASE_PATH, 'code-checker-mcp'),
        env: {
            PYTHONPATH: path_1.default.join(BASE_PATH, 'code-checker-mcp/src'),
            PYTHONUNBUFFERED: '1',
    ...
    'mem0': {
        ...
        cwd: path_1.default.join(BASE_PATH, 'mem0-mcp'),
        env: {
            MEM0_API_KEY: process.env.MEM0_API_KEY || '',
            PYTHONPATH: path_1.default.join(BASE_PATH, 'mem0-mcp'),
            PYTHONUNBUFFERED: '1',
            PYTHONIOENCODING: 'utf-8',
            LANG: 'C.UTF-8',
            LC_ALL: 'C.UTF-8'
    ...
    'context7': {
        ...
        command: 'node',
        args: ['dist/index.js'],
        cwd: path_1.default.join(BASE_PATH, 'context7-mcp'),
        env: {
    ...
    'clear-thought': {
        ...
        command: 'node',
        args: ['dist/main.js'],
        cwd: path_1.default.join(BASE_PATH, 'clear-thought-mcp'),
        env: {},
        capabilities: ['tools'],
        startupTimeout: 10000
    },
    ...
    'stochastic-thinking': {
        ...
        cwd: path_1.default.join(BASE_PATH, 'stochastic-thinking-mcp'),
        env: {},
        capabilities: ['tools'],
        startupTimeout: 10000
    },
    ...
    'sequential-thinking-tools': {
        ...
        command: 'node',
        args: ['index.js'],
        cwd: path_1.default.join(BASE_PATH, 'sequential-thinking-tools'),
        env: {
            NODE_ENV: 'production',
            LANG: 'C.UTF-8',
            LC_ALL: 'C.UTF-8'
    ...
    'npm-sentinel': {
        ...
        command: 'node',
        args: ['dist/index.js'],
        cwd: path_1.default.join(BASE_PATH, 'npm-sentinel-mcp'),
        env: {
    ...
    'mermaid': {
        ...
        command: 'node',
        args: ['dist/index.js'],
        cwd: path_1.default.join(BASE_PATH, 'mermaid-mcp'),
        env: {
    ...
    'node-omnibus': {
        ...
        command: 'node',
        args: ['build/index.js'],
        cwd: path_1.default.join(BASE_PATH, 'node-omnibus-mcp'),
        env: {},
        capabilities: ['tools']
    },
    ...
    'code-context-provider': {
        ...
        command: 'node',
        args: ['dist/index.js'],
        cwd: path_1.default.join(BASE_PATH, 'code-context-provider-mcp'),
        env: {},
        capabilities: ['tools', 'resources']
    },
    ...
    'desktop-commander': {
        ...
        command: 'node',
        args: ['dist/index.js'],
        cwd: path_1.default.join(BASE_PATH, 'desktop-commander-mcp'),
        env: {
    ...
    'nodejs-debugger': {
        ...
        cwd: path_1.default.join(BASE_PATH, 'nodejs-debugger-mcp'),
        env: {},
        capabilities: ['tools']
    },
    // Serper Search MCP
    'serper-search': {
        ...
        command: 'node',
        args: ['build/index.js'],
        cwd: path_1.default.join(BASE_PATH, 'serper-search-mcp'),
        env: {
    ...
    'vercel': {
        ...
        command: 'node',
        args: ['dist/index.js'],
        cwd: path_1.default.join(BASE_PATH, 'vercel-mcp'),
        env: {
    ...
    '21stdev-magic': {
        ...
        command: 'node',
        args: ['dist/index.js'],
        cwd: path_1.default.join(BASE_PATH, '21stdev-magic-mcp'),
        env: {
    ...
    'taskmaster-ai': {
        ...
        cwd: path_1.default.join(BASE_PATH, 'taskmaster-ai-mcp'),
        env: {
            ...
            PYTHONPATH: path_1.default.join(BASE_PATH, 'taskmaster-ai-mcp'),
            PYTHONUNBUFFERED: '1',
            PYTHONIOENCODING: 'utf-8',
            LANG: 'C.UTF-8',
            LC_ALL: 'C.UTF-8'
    ...
    'code-runner': {
        ...
        cwd: path_1.default.join(BASE_PATH, 'code-runner-mcp'),
        env: {},
        capabilities: ['tools'],
        startupTimeout: 10000
    },
    ...
    'docker': {
        ...
        cwd: path_1.default.join(BASE_PATH, 'docker-mcp'),
        env: {
            DOCKER_HOST: process.env.DOCKER_HOST || 'unix:///var/run/docker.sock',
            PYTHONPATH: path_1.default.join(BASE_PATH, 'docker-mcp'),
            PYTHONUNBUFFERED: '1',
            PYTHONIOENCODING: 'utf-8',
            LANG: 'C.UTF-8',
            LC_ALL: 'C.UTF-8'
    ...
    'github': {
        ...
        command: 'node',
        args: ['dist/index.js'],
        cwd: path_1.default.join(BASE_PATH, 'github-mcp'),
        env: {
    ...
    'supabase': {
        ...
        command: 'node',
        args: ['dist/index.js'],
        cwd: path_1.default.join(BASE_PATH, 'supabase-mcp'),
        env: {
    ...
    'serena': {
        ...
        cwd: path_1.default.join(BASE_PATH, 'serena-mcp'),
        env: {
            SERENA_PROJECT_DIR: process.env.SERENA_PROJECT_DIR || BASE_PATH,
            PYTHONPATH: path_1.default.join(BASE_PATH, 'serena-mcp/src'),
            PYTHONUNBUFFERED: '1',
            PYTHONIOENCODING: 'utf-8',
            LANG: 'C.UTF-8',
            LC_ALL: 'C.UTF-8'
    ...
    'playwright': {
        ...
        cwd: path_1.default.join(BASE_PATH, 'playwright-mcp'),
        env: {
            PLAYWRIGHT_SKIP_BROWSER_DOWNLOAD: 'true',
            DISPLAY: ':99',
            PYTHONPATH: path_1.default.join(BASE_PATH, 'playwright-mcp'),
            PYTHONUNBUFFERED: '1',
            PYTHONIOENCODING: 'utf-8',
            LANG: 'C.UTF-8',
            LC_ALL: 'C.UTF-8'
...
//# sourceMappingURL=mcp-services-windows.js.map