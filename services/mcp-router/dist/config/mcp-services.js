...
exports.MCP_SERVICES_CONFIG = void 0;
exports.MCP_SERVICES_CONFIG = {
    ...
    'taskmaster-ai': {
        ...
        env: {
            ...
            TASKMASTER_MCP_ROUTING: 'true', // Enable MCP routing for Task tools
            TASKMASTER_ROUTER_URL: 'http://localhost:3000' // Internal router URL
        },
        capabilities: ['tools', 'resources'],
    ...
    // HDAP API Bridge MCP - $0 Cost AI API Bridge
    'hdap-api-bridge': {
        name: 'hdap-api-bridge',
        command: 'sh',
        args: ['run.sh'],
        cwd: '/app/services/mcp/hdap-api-bridge-mcp',
        env: {
            PORT: process.env.HDAP_PORT || '3001',
            RUNTIME_DIR: '/app/services/mcp/hdap-api-bridge-mcp/runtime',
            NODE_ENV: 'production',
            DEBUG: process.env.HDAP_DEBUG || '',
            LANG: 'C.UTF-8',
            LC_ALL: 'C.UTF-8'
        },
        capabilities: ['tools'],
        startupTimeout: 15000 // tsx 로딩 및 Bridge 서버 시작 시간 고려
    },
    // Cloudflare MCP Server - Official DNS, Analytics, Workers management
    'cloudflare': {
        name: 'cloudflare',
        command: 'sh',
        args: ['run.sh'],
        cwd: '/app/services/mcp/cloudflare-mcp',
        env: {
        ...
        capabilities: ['tools', 'resources'],
        startupTimeout: 20000 // pnpm install and build time
    },
    // Mobile MCP - Mobile automation and testing
    'mobile': {
        name: 'mobile',
        command: 'sh',
        args: ['run.sh'],
        cwd: '/app/services/mcp/mobile-mcp',
        env: {
            NODE_ENV: 'production',
            LANG: 'C.UTF-8',
            LC_ALL: 'C.UTF-8'
        ...
        capabilities: ['tools'],
        startupTimeout: 20000 // npm install and build time
    }
};
//# sourceMappingURL=mcp-services.js.map